						  ...
						  <tbody>
						  	...
						  	?>	
									      ...
									      <td class="d-grid gap-2 d-md-flex justify-content-md-center">
									      	<a href="index.php?page=view_project&id=<?php echo $row['proj_id'] ?>" data-id="<?php echo $row['proj_id'] ?>" class="btn btn-sm btn-primary view_btn"><i class="fas fa-eye"></i> View</button>
